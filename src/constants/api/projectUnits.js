...
const projectUnits = {
    getAll: (options = { params: {} }) =>
        axios.get('/project/units/v1/user/pic-pusat/', options),
    get: (id) => axios.get(`/project/units/v1/user/pic-pusat/${id}/show`),
    ...
    getProgress: (options = { params: {} }) =>
        axios.get('project/units/v1/user/pic-pusat/get-progress', options),
}
